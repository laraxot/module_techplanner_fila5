---
title: "Code Quality Improvement Report — TechPlanner"
type: report
tags: [code-quality, phpstan, pest, maintainability]
module: "TechPlanner"
created: 2026-07-17
updated: 2026-07-17
qmd: "code quality baseline PHPStan Pest strict types Laraxot TechPlanner"
story: STORY-001
issues:
...
# Code Quality Improvement Report — TechPlanner
...
| Indicatore | Valore |
|---|---:|
| File PHP applicativi/database/route | 141 |
| File di test PHP | 3 |
| Rapporto test/file PHP | 2% |
| Candidati senza strict types | 141 |
...
2. **app/Models/Worker.php:253:        // TODO: Implement jobRoles relation before using this scope — debito eseguibile.** Verificare il caller e scegliere una sola uscita: implementare il comportamento con un test che fallisce prima della patch, oppure eliminare ramo e marker se non raggiungibili. Non lasciare il TODO come documentazione.
...
Dalla cartella laravel/:
    ...
    ./vendor/bin/phpstan analyse Modules/TechPlanner --memory-limit=-1
