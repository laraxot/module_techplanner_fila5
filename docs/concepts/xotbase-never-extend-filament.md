---
title: "TechPlanner — mai Filament\*, sempre XotBase*"
type: concept
module: TechPlanner
tags: [techplanner, filament, xotbase, architecture]
created: 2026-07-16
updated: 2026-07-16
qmd: "TechPlanner filament never extend Filament class XotBase mirror path"
related:
...
Nessuna classe in `Modules/TechPlanner` estende una classe `Filament\...` direttamente.
